 ...
 * from the specification file <tt>D:/IdeaProjects/httpmock/src/main/java/ink/organics/httpmock/language/httpmock.flex</tt>
 */
class HTTPMockLexer implements FlexLexer {
  ...
  private static final String ZZ_ACTION_PACKED_0 =
    "\2\0\2\1\1\2\1\3\1\4\1\5\2\1\2\6"+
    "\1\3\1\6\1\0\2\4\1\0\1\2\2\1";
   ...
   */
  HTTPMockLexer(java.io.Reader in) {
    this.zzReader = in;
  }
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            { yybegin(YYINITIAL); return HTTPMockTypes.TODO;
            } 
            // fall through
          case 7: break;
          case 2: 
          ...
          case 9: break;
          case 4: 
            { yybegin(YYINITIAL); return HTTPMockTypes.COMMENT;
            } 
            // fall through
          case 10: break;
          case 5: 
            { yybegin(WAITING_VALUE); return HTTPMockTypes.TODO;
            } 
            // fall through
          case 11: break;
          case 6: 
