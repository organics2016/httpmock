...
public class HTTPMethodImpl extends HTTPMockCompositeElementImpl implements HTTPMethod {
  ...
  @Override
  @NotNull
  public PsiElement getRequestMethod() {
    return findNotNullChildByType(REQUEST_METHOD);
  }
